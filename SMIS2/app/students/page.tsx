...
import type { Student, StudentFormData, StudentSummary } from "@/features/student-management/types/student";
  ...
  const filteredStudents = useMemo(() => {
    ...
    return students.filter((s) => {
      const matchesSearch = term
        ? [s.firstName, s.lastName, s.email, s.admissionNumber].some((v) =>
